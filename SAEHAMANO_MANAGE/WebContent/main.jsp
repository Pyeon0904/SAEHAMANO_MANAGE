...
<!-- 축제 -->		
	...
	<div class="gotodetail">
		<a href="<%= request.getContextPath() %>/admin/event"><p>더 보기</p></a>
	</div>	
</div>
</section>
</div>		
